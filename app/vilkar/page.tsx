      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                Du må være 18 år eller eldre for å bruke RuneSpark Studio. Ved å bruke plattformen, bekrefter du at du
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                RuneSpark Studio og alt innhold, funksjoner og funksjonalitet er og vil forbli RuneSpark Studios
